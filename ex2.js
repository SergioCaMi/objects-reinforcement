...
console.log(flightReservation.departure.time);
...
console.log(flightReservation.specialMeals);
...
flightReservation.totalPrice = `$${flightReservation.totalPrice.slice(1) - (parseFloat(flightReservation.totalPrice.slice(1) * (0.15)).toFixed(2))}`
console.log(flightReservation.totalPrice)
